...
- "[N marks each]" means every question in that range is worth N marks.
- assessment.total_marks must equal the exact sum of all max_marks. Add them up yourself and double-check before outputting.
